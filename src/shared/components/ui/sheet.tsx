...
const sheetVariants = cva(
  "fixed z-50 gap-6 bg-background p-6 shadow-card transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out md:p-8",
  {
    variants: {
      side: {
